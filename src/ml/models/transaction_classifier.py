...
class TransactionClassifier:
    ...
    def suggest_reason(self, transaction: Dict[str, Any], category: str) -> List[Tuple[str, float]]:
        ...
        templates = reason_templates.get(category.lower(), [
    ...
    def _get_similarity_category_suggestions(self, 
                                             transaction: Dict[str, Any]) -> List[Tuple[str, float]]:
    ...
    def _get_pattern_category_suggestions(self, 
                                          features: Dict[str, Any]) -> List[Tuple[str, float]]:
    ...
    def _calculate_feature_confidence(self, features: Dict[str, Any]) -> float:
        ...
        non_zero_features = sum(1 for value in features.values() 
