...
class SimilarityEngine:
    ...
    def find_similar_descriptions(self, 
                                  target_description: str, 
                                  candidate_descriptions: List[str]) -> List[Tuple[str, float]]:
    ...
    def find_similar_merchants(self, 
                               target_description: str, 
                               known_merchants: Dict[str, str]) -> List[Tuple[str, str, float]]:
    ...
    def calculate_merchant_confidence(self, 
                                      description: str, 
