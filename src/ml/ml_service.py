...
class MLSuggestionService:
    ...
    def suggest_regex_pattern(self, description: str, 
                              similar_descriptions: List[str] = None) -> Optional[Dict[str, Any]]:
    ...
    def suggest_enum_category(self, description: str, 
                              existing_patterns: List[str] = None) -> List[Dict[str, Any]]:
    ...
    def suggest_transaction_reason(self, transaction: Dict[str, Any], 
    ...
    def provide_feedback(self, transaction: Dict[str, Any], 
                         suggestion_type: str,
                         suggested_value: str,
                         user_action: str,
    ...
    def _infer_category_from_pattern(self, pattern: str) -> str:
        ...
        category_keywords = {
            'food': ['swiggy', 'zomato', 'food', 'restaurant', 'cafe', 'dominos', 'pizza', 'meal'],
            'transport': ['uber', 'ola', 'metro', 'bus', 'taxi', 'auto', 'travel', 'fuel'],
            'shopping': ['amazon', 'flipkart', 'myntra', 'mall', 'store', 'shopping', 'purchase'],
            'utility': ['electricity', 'water', 'gas', 'phone', 'internet', 'wifi', 'bill'],
            'medical': ['hospital', 'pharmacy', 'medical', 'doctor', 'clinic', 'health'],
            'entertainment': ['movie', 'netflix', 'spotify', 'game', 'youtube', 'music'],
