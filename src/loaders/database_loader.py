...
class DatabaseLoader:
    ...
    def get_or_create_institution(self, name: str, institution_type: str):
        ...
        try:
            ...
            institution = (
                ...
                .filter_by(name=name, institution_type=institution_type)
                .first()
            )

            if not institution:
                # Create new
                institution = Institution(name=name, institution_type=institution_type)
    ...
    def create_or_update_enum(
        self, enum_name: str, patterns: list, category: str, processor_type: str
    ):
        ...
        try:
            ...
            enum_obj = (
                ...
                .filter_by(enum_name=enum_name, processor_type=processor_type)
                .first()
            )
    ...
    def create_transaction(self, transaction_data: Dict[str, Any]):
        ...
        try:
            ...
            if splits_data:
                transaction_amount = (
                    transaction_data.get("debit_amount")
                    or transaction_data.get("credit_amount")
                    or 0
                )
    ...
    def _create_transaction_splits(
        self,
        session,
        transaction_id: int,
    ...
    def get_person_total_amount(self, person_name: str, start_date=None, end_date=None):
        ...
        try:
            ...
            query = (
                session.query(func.sum(TransactionSplit.amount))
