...
class TestIciciBankTransformerCurrency:
    ...
    def multi_currency_config(self):
        ...
        return {"processors": {"icici_bank": {"currency": ["USD", "EUR", "GBP", "INR"]}}}
    ...
    def test_transformer_invalid_currency_config(self, mock_db_manager, mock_config_loader):
        ...
        invalid_config = {
            "processors": {"icici_bank": {"currency": ["XX", "123", "AB"]}}  # All invalid
        }
    ...
    def test_determine_currency_multi_currency_ambiguous(self, transformer_multi_currency):
        ...
        with patch.object(
            transformer_multi_currency.currency_detector, "detect_currency", return_value=None
        ), patch.object(
            transformer_multi_currency.currency_detector,
            "ask_user_for_currency",
            return_value="USD",
    ...
    def test_transform_transaction_includes_currency(self, transformer_multi_currency):
        ...
        with patch.object(
            transformer_multi_currency, "_determine_transaction_currency", return_value="USD"
        ):
    ...
    def test_transform_transaction_currency_determination_called(self, transformer_multi_currency):
        ...
        with patch.object(
            transformer_multi_currency, "_determine_transaction_currency", return_value="EUR"
        ) as mock_determine:
            row_data = {
                "Transaction Date": "15/01/2024",
