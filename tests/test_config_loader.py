...
class TestConfigLoader:
    ...
    def test_load_categories_with_new_database_categories(self, temp_config_dir):
        ...
        with patch.object(loader, '_load_template_categories', return_value=template_categories), \
             patch.object(loader, '_extract_database_categories', return_value=db_categories), \
             patch.object(loader, '_merge_categories', return_value=template_categories + db_categories) as mock_merge, \
    ...
    def test_load_template_categories_default_when_file_missing(self):
        ...
        expected_defaults = [
            {'name': 'income'}, {'name': 'food'}, {'name': 'transport'},
            {'name': 'shopping'}, {'name': 'entertainment'}, {'name': 'utilities'},
            {'name': 'healthcare'}, {'name': 'transfer'}, {'name': 'investment'},
            {'name': 'other'}
        ]
    ...
    def test_extract_database_categories_success(self):
        ...
        mock_session.query.return_value.distinct.return_value.all.side_effect = [
            enum_categories, transaction_categories
        ]
    ...
    def test_merge_categories_yaml_priority(self):
        ...
        database_categories = [
            {'name': 'food'}, {'name': 'medical'}, {'name': 'education'}
        ]
    ...
    def test_merge_categories_case_insensitive(self):
        ...
        expected = [
            {'name': 'Food'}, {'name': 'TRANSPORT'}, {'name': 'Medical'}
        ]
    ...
    def test_add_category_new_category(self, temp_config_dir):
        ...
        with patch.object(loader, '_load_template_categories', return_value=existing_categories), \
    ...
    def test_add_category_maintains_template_order(self, temp_config_dir):
        ...
        with patch.object(loader, '_load_template_categories', return_value=template_categories), \
            ...
            expected = [
                {'name': 'income'}, {'name': 'food'},  # Template order
                {'name': 'custom'}, {'name': 'medical'}  # Custom categories
            ]
    ...
    def test_edge_case_empty_string_category(self, temp_config_dir):
        ...
        with patch.object(loader, '_load_template_categories', return_value=[]), \
             patch.object(loader, 'save_categories') as mock_save:
