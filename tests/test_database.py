...
from src.models.database import create_models_with_prefix, DatabaseManager
...
class TestCreateModelsWithPrefix:
    ...
    def test_create_models_no_prefix(self):
        ...
        expected_models = [
            'Institution', 'ProcessedFile', 'TransactionEnum', 
            'Transaction', 'TransactionSplit', 'SkippedTransaction', 'ProcessingLog'
        ]
    ...
    def test_transaction_model_attributes(self):
        ...
        expected_columns = [
            'id', 'transaction_hash', 'institution_id', 'processed_file_id',
            'transaction_date', 'description', 'debit_amount', 'credit_amount',
            'balance', 'reference_number', 'transaction_type', 'enum_id',
            'category', 'transaction_category', 'reason', 'splits',
            'has_splits', 'is_settled', 'created_at', 'updated_at'
        ]
...
class TestDatabaseManager:
    ...
    def test_database_manager_init_production_mode(self):
        ...
        with patch('src.models.database.create_engine') as mock_create_engine, \
    ...
    def test_all_model_types_accessible(self):
        ...
        with patch('src.models.database.create_engine'), \
            ...
            expected_models = [
                'Institution', 'ProcessedFile', 'TransactionEnum',
                'Transaction', 'TransactionSplit', 'SkippedTransaction', 
                'ProcessingLog'
            ]
