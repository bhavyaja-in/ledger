...
class TestMLIntegration:
    ...
    def test_ml_pattern_learning_simulation(self, full_ml_service):
        ...
        if suggestions:
            food_found = any(
                "food" in suggestion["category"].lower() 
    ...
    def test_ml_contextual_reasoning(self, full_ml_service):
        ...
        if reasons:
            for reason in reasons:
                ...
                assert ("food" in reason_text or 
                       "pizza" in reason_text or 
                       "dominos" in reason_text or
                       "restaurant" in reason_text)
    ...
    def test_ml_confidence_scoring(self, full_ml_service):
        ...
        for case in test_cases:
            ...
            if case["expected_confidence"] == "high":
                ...
                assert 0 <= confidence <= 1, f"Invalid confidence for unclear pattern: {case['description']}"
