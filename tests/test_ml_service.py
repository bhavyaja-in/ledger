...
class TestMLSuggestionService:
    ...
    def test_suggest_transaction_reason(self, ml_service, sample_transaction):
        ...
        for suggestion in suggestions:
            ...
            assert (category_lower in reason_lower or 
                   "food" in reason_lower or 
                   "merchant" in reason_lower), f"Reason '{suggestion['reason']}' not related to category '{category}'"
    ...
    def test_disabled_ml_methods(self, disabled_ml_service, sample_transaction):
        ...
        reason_suggestions = disabled_ml_service.suggest_transaction_reason(sample_transaction, "food")
    ...
    def test_calculate_pattern_confidence(self, ml_service):
        ...
        confidence1 = ml_service._calculate_pattern_confidence(
            ".*swiggy.*", 
            ["UPI-SWIGGY-DELIVERY", "UPI-SWIGGY-ORDER"]
        )
